    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-4">
                ...
                <p class="text-muted justify">
                    Elemento de ligação entre cliente, produto e funcionário, o endomarketing ajuda esses a se tornarem aliados ao negócio e responsáveis pelo sucesso da empresa. O relacionamento  positivo dentro de uma corporação é tão importante quanto o existente com seus consumidores.</p>
            </div>
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
