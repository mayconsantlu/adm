    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-4">
                ...
                <h4 class="service-heading">Endomarketing</h4>
                <p class="text-muted justify">Elemento de ligação entre cliente, produto e funcionário, o endomarketing ajuda esses a se tornarem aliados ao negócio e responsáveis pelo sucesso da empresa. O relacionamento  positivo dentro de uma corporação é tão importante quanto o existente com seus consumidores.</p>
                </p>
            </div>
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                ...
                <h4 class="service-heading">Materiais de comunicação</h4>
                <p class="text-muted justify">A comunicação visual é muito importante para uma empresa, pois a visão é o primeiro sentido responsável pelo processo de escolha de uma pessoa. Dentre os vários tipos de materiais de comunicação que montamos, estão: folders, tags, flyers, entre outros.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body">
                        ...
                        <img class="img-responsive" src="template/img/portfolio/roundicons-free.png" alt="">
