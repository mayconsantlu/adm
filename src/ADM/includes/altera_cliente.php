...
if (!empty($_POST)) {
    ...
    if (isset($_POST['nome'])) {
        ...
        if (!empty($_POST['nome'])) {
            ...
            $sql1 = "update tbl_clientes set nome = '$nome', cnpj = '$cnpj', contato = '$contato', email = '$email', telefone = '$telefone', obs  = '$obs' where id = '$editar';";
...
<div class="">
    ...
    <!-- Alert -->
    <?php
    $query = "Select * from tbl_clientes where id = '$editar';";
    ...
    <form class="form-inline" method="post" action="">
        ...
        <div class="row clearfix">
            <div class="col-md-6 column">
                <h3>Nome Razão *</h3>
                <input id="nome" name="nome" type="text" style="width: 100%" placeholder="Digite o Nome/Razão" class="form-control" value="<?php echo $resultado['nome']; ?>" >
                <span class="help-block">* Nome ou Razão social do cliente.</span>
                <h3>CPF/CNPJ</h3>
                <input id="cnpj" name="cnpj" type="text" style="width: 100%" placeholder="Digite o CPF ou CNPJ do cliente" class="form-control" value="<?php echo $resultado['cnpj']; ?>" >
                <h3>Contato</h3>
                <input id="contato" name="contato" type="text" style="width: 100%" placeholder="Digite o nome da pessoa de contato" class="form-control" value="<?php echo $resultado['contato']; ?>" >
            </div>
            <div class="col-md-6 column">
                <h3>e-mail</h3>
                <input id="email" name="email" type="email" style="width: 100%" placeholder="Digite o e-mail do cliente" class="form-control" value="<?php echo $resultado['email']; ?>" >
                <h3>Telefone</h3>
                <input id="telefone" name="telefone" type="tel" style="width: 100%" class="form-control" value="<?php echo $resultado['telefone']; ?>" >
                <h3>Observação</h3>
                <textarea class="form-control" cols="10" style="width: 100%" id="texto" name="texto"><?php echo $resultado['obs']; ?></textarea>
            </div>
        </div>
        <hr>
        <div class="row clearfix">
